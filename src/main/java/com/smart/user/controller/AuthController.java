...
import com.smart.user.helper.jwt.JwtUtils;
import com.smart.user.model.JwtResponse;
import com.smart.user.model.LoginRequest;
import com.smart.user.model.MessageResponse;
import com.smart.user.model.SignupRequest;
import com.smart.user.service.RoleService;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        user.setRoles(roles);
        userService.getUserGenericService().add(user);
